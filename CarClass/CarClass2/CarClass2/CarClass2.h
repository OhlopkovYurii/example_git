...
public:
    ...
    /// const string &transmission1 - трансмиссия const - для предотвращения изменений transmission, ? - передача по ссылке (transmission может занимать много памяти) 
